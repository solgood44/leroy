...
const PROGRAM_PAGES = [
  {
    url: "/program/celebration-cover.jpg",
    label: "Celebration of Life program — cover",
  },
  {
    url: "/program/celebration-order.jpg",
    label: "Celebration of Life program — order of service",
  },
] as const;
...
export function LeroyMemories({
  ...
  return (
    <>
      ...
      <MemorialAnnouncement onOpenLightbox={openLightbox} />
